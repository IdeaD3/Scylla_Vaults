            ...
            if (main.utils.isEditor(player.getUniqueId())) {
                ...
                if (args[0].equalsIgnoreCase("add")) {
                    ...
                    try {
                        ...
                        main.utils.logEvent(player.getUniqueId(), player.getInventory().getItemInMainHand(), "Insert", target.getUniqueId());
                        return true;
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    return true;
                        ...
                        args[1].equalsIgnoreCase("logs")) {
                    VaultLogs.get().set("logs", null);
